...
silver_data = spark.readStream.schema(silver_schema).parquet("s3a://hwe-fall-2024/irajasekaran/silver/reviews")
...
.groupBy("review_timestamp","gender","state")\
.agg(sum("total_votes").alias("totalVotes"))
...
.outputMode("append") \
.format("delta") \
.option("path", f's3a://hwe-fall-2024/irajasekaran/gold/reviews') \
